...
import { FaLinkedin, FaSquareReddit, FaXTwitter } from "react-icons/fa6";
const Footer = () => {
  return (
    <footer
        ...
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
            <div className="mb-12 max-w-[360px] lg:mb-16">
              <Link
                href="/"
                className="mb-8 flex flex-row items-center space-x-2"
              >
                <Image
                  src={Images.logo}
                  ...
                  height={30}
                />
                <p className="text-2xl font-bold">Publish Studio</p>
              </Link>
      ...
      <div className="absolute right-0 top-14 z-[-1]">
        ...
        >
          ...
          <mask
            ...
            height="99"
          >
            <circle opacity="0.8" cx="49.5" cy="49.5" r="49.5" fill="#EB5757" />
          </mask>
        ...
        >
          ...
          <defs>
            <linearGradient
              ...
              gradientUnits="userSpaceOnUse"
            >
              <stop stopColor="#EB5757" stopOpacity="0.62" />
            ...
            <linearGradient
              ...
              gradientUnits="userSpaceOnUse"
            >
              <stop stopColor="#EB5757" stopOpacity="0" />
              <stop offset="1" stopColor="#EB5757" stopOpacity="0.51" />
            </linearGradient>
            <linearGradient
