  ...
  return (
    <div className="m-10 space-y-8">
      <Section>
        ...
        <p className="text-xs font-bold">Last updated August 17, 2024</p>
      </Section>
      <Section>
        <p>
          This Cookie Policy explains how Publish Studio (&quot;Company,&quot;
          &quot;we,&quot; &quot;us,&quot; &quot;our&quot;) uses cookies and
          similar technologies to recognize you when you visit our website at
          <LinkButton href={siteConfig.url}>{siteConfig.url}</LinkButton>{" "}
      ...
      <Section>
        ...
        <p>
          ...
          <LinkButton href={siteConfig.url}>{siteConfig.url}</LinkButton>) are
      ...
      <Section>
        <Heading level={2}>How can I control cookies?</Heading>
        <p>
      ...
      <Section>
        ...
        <List>
          <li>
            <LinkButton href={"http://www.aboutads.info/choices/"}>
              Digital Advertising Alliance
            </LinkButton>
          </li>
          <li>
            <LinkButton href={"https://youradchoices.ca/"}>
              Digital Advertising Alliance of Canada
            </LinkButton>
          </li>
          <li>
            <LinkButton href={"http://www.youronlinechoices.com/"}>
...
Please note that setting the Flash Player to restrict or limit acceptance of Flash Cookies may reduce or impede the functionality of some Flash applications, including, potentially, Flash applications used in connection with our services or online content. */}
      ...
      <Section>
        <Heading level={2}>Do you serve targeted advertising?</Heading>
        <p>
      ...
      <Section>
        <Heading level={2}>Where can I get further information?</Heading>
        <p>
          If you have any questions about our use of cookies or other
          technologies, please contact us at: support@publishstudio.one
        </p>
      </Section>
    </div>
  );
